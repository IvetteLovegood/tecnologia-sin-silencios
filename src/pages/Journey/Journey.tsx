...
export function Journey({ data, step, camino, responses, onUpdate, onNext, onPrev }: Props) {
  ...
  if (step === 2) return (
    <div className={styles.wrap}>
      ...
      <div className={styles.qLabel}>¿Te ha pasado algo de esto?</div>
      <QuestionList questions={data.m1Qs} />
  ...
  if (step === 3) return (
    <div className={styles.wrap}>
      ...
      {/* Respuesta adaptativa: si dijo "sí" en m1, reforzar */}
      {responses.m1SiPasó && (
      ...
      <div className={styles.qLabel}>¿Has vivido algo parecido?</div>
      <QuestionList questions={data.m2Qs} />
  ...
  if (step === 4) return (
    <div className={styles.wrap}>
      ...
      {/* Adaptativo: si cree que es estructural, validar y profundizar */}
      ...
      <div className={styles.qLabel}>¿Algo de esto te resulta familiar?</div>
      <QuestionList questions={data.m3Qs} />
  ...
  if (step === 5) return (
    <div className={styles.wrap}>
      ...
      <div className={styles.qLabel} style={{ marginTop: 22 }}>¿Algo de esto conecta con lo que has vivido?</div>
      <QuestionList questions={data.m4Qs} />
      <NavBtns />
    </div>
  )
  ...
  if (step === 6) return (
    <div className={styles.wrap}>
      ...
      <div className={styles.qLabel}>¿Esto te resuena?</div>
      <QuestionList questions={camino === 'est'
        ? [
